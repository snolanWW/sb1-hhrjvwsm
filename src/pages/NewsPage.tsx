        ...
        <div className="relative flex-grow flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
            <h1 className="font-playfair text-5xl md:text-7xl font-bold text-white mb-6 max-w-4xl">
              Stories That Matter, News That Connects
            </h1>
            <p className="text-xl text-white/90 max-w-2xl mb-8">
              Discover the latest news and in-depth coverage of Doylestown and Bucks County. From local politics to community events, we bring you the stories that shape our community.
            </p>
          </div>
        </div>
